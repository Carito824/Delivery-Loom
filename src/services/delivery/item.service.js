    class ItemService {
      ...
      async create(data) {
        try {
          if (!data || !data.name || !data.price) {
            return this._utilities.io.response.error('Please provide name and price');
          }
          ...
          const entity = new this._models.ItemModel(data, this._dependencies);
        ...
        try {
          ...
          switch (data.queryselector) {
            case 'id':
              ...
              break;
            case 'name':
              response = await this.#getByName(data);
              break;
            case 'price':
              response = await this.#getByPrice(data);
              break;
            case 'menuid':
                response = await this.#getByMenuid(data);
                break;
            case 'all':
      ...
      async #getByPrice(data) {
                try {
                  ...
                  return this.#getByFilters({
                      filters: [
                        { key: 'price', operator: '==', value: data.search }  
                      ]
                    });
      ...
      async #getByMenuid(data) {
                  try {
                    ...
                    return this.#getByFilters({
                        filters: [
                          { key: 'menuid', operator: '==', value: data.search }  
                        ]
                      });
    ...
    get status() {
    return this._models.ItemModel.statuses;
  }
  }
