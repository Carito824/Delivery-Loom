const router = {
  ...
  delivery: [
    // Template
    {
      httpRoute: '/menu/:queryselector',
      route: '/routes/api/delivery/_menu.route',
      handler: 'get',
      method: 'GET',
      protected: false,
    },
    ...
    {
      httpRoute: '/item/:queryselector',
      route: '/routes/api/delivery/_item.route',
      handler: 'get',
      method: 'GET',
      protected: false,
    },
    ...
    {
      httpRoute: '/order/:queryselector',
      route: '/routes/api/delivery/_order.route',
      handler: 'get',
      method: 'GET',
      protected: false,
    },
